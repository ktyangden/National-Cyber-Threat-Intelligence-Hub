    ...
    return (
      <section id="features" className="py-8 px-4 lg:py-16 lg:px-8">
        <div className="md:px-8 px-6 md:py-12 py-8 w-full flex flex-col items-center justify-center gap-4 text-center">
            <h1 className="text-3xl font-bold leading-none sm:text-4xl text-foreground">Powerful Threat Intelligence, Simplified</h1>
            <p className="text-xl max-w-130 text-muted-foreground">Everything you need to monitor attacks, analyze patterns, and stay ahead of emerging risks</p>
        </div>
