...
return (
  <div
    className={cn(
      "w-110 cursor-pointer h-120 overflow-hidden bg-white dark:bg-black rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.02)] border border-gray-200/80 dark:border-gray-200/20",
      className
    )}
  >
    {image && (
      <div className="relative h-98 rounded-lg shadow-lg overflow-hidden w-[calc(100%-1rem)] mx-2 mt-2">
        <img
          src={image}
          alt="card"
        ...
        return (
          ...
          >
            <Card
              ...
              image={card.image}
            >
              <TextRoll className="text-3xl font-bold uppercase mt-3 text-foreground">{card.title}</TextRoll>
            </Card>
          </motion.div>
        );
      })}
